...
2.times do
  Post.create!(location: @location3, image: 'https://www.rdsenvironmental.com/wp-content/uploads/2017/11/ThinkstockPhotos-637186808.jpg', title: 'when will be able to live in houses with NO mold???', message: 'Too much mold, not enough caring. Let\'s get that WOF on houses!!', user: @admin)
end

2.times do
  Post.create!(location: @location4, image: 'https://cdn-prod.medicalnewstoday.com/content/images/articles/288/288651/mold-in-the-home.jpg', title: 'Not with the price', message: 'I\'ve seen shacks with better foundations than this place', user: @admin)
end
